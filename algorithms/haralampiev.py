...
class HaralampievNetwork:
    """
    This class contains the approach described in the paper 'Theoretical Justification of a Neural Network Approach
    to Combinatorial Optimization'
    """

    def __init__(self, n, k, graph):
