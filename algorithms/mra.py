...
class MRA:
    ...
    def run(self):
        ...
        for iteration in range(self.p):
            ...
            temp_vertices = [0 for _ in range(self.n)]
            
            # randomly pick k vertices
            for value in random.sample([i for i in range(0, self.n)], k=self.k):
        ...
        for i in range(len(self.intersection)):
            ...
            exclusion_list.append(self.intersection[i])
        ...
        available_list = [i for i in range(self.n)]     
        ...
        temp_vertices = [0 for _ in range(self.n)]
        temp_k = self.k - len(self.intersection)
        ...
        for i in range(self.n):
            ...
            if i in self.intersection or (sub_facilities is not None and i in sub_facilities):
        ...
        facilities = self.simple(self.vertices)
    ...
    def simple(self, vertices, exclusion_list=None):
        ...
        while True:
            ...
            if time.time() - start_time >= self.maxTime / 5:
            ...
            if exclusion_list is None:
                ...
                available_clients = [i for i in range(self.n) if vertices[i] == 0]
                
            else:
            
                available_clients = [i for i in range(self.n) if i not in exclusion_list and vertices[i] == 0]
            ...
            for client in available_clients:
                ...
                if exclusion_list is None:
                    ...
                    available_facilities = [i for i in range(self.n) if vertices[i] == 1]
                    
                else:
                
                    available_facilities = [i for i in range(self.n) if i not in exclusion_list and vertices[i] == 1]
        ...
        if exclusion_list is None:
            ...
            return [i for i in range(self.n) if vertices[i] == 1]
            
        else:
        
            return [i for i in range(self.n) if i not in exclusion_list and vertices[i] == 1]
        ...
        for i in range(self.n):
            ...
            for j in range (self.n):
                ...
                if i != j:
                    ...
                    if 1 - self.graph._normalized_distances[i][j] > val:
                    
                        val = 1 - self.graph._normalized_distances[i][j]
                        index = j
                        
            if index in self.intersection:
