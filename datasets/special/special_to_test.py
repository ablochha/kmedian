"""
This script takes a special file and converts it into the test format that can be read by the standard dataset
loader class.
...
optimal_distances = {}
with open('original_files/specialopt.txt', 'r') as f:
    # skip the headers
    f.readline()
